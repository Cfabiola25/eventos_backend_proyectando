<!-- MODAL DE CONFIRMACIÓN PARA CAMBIOS BOOLEANOS - NUEVO -->
<div id="confirm-toggle-modal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
    <div class="bg-white rounded-lg shadow-xl w-full max-w-md mx-4">
        ...
        <div class="bg-primary-600 text-white p-4 rounded-t-lg flex justify-between items-center">
            ...
            <button onclick="closeConfirmToggleModal()"
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-yellow-700">
                            Esta acción cambiará el estado inmediatamente.
                        </p>
                    </div>
                </div>
            </div>
