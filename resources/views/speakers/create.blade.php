...
<div class="w-full px-4 py-6 mx-auto mt-16">
    ...
    <!-- Formulario -->
    <form action="{{ route('speakers.store') }}" method="POST" id="speakerForm">
        @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="bio"
                                      ...
                                      class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all resize-none @error('bio') border-red-500 @enderror">{{ old('bio') }}</textarea>
                            @error('bio')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                            <p class="text-xs text-gray-500 mt-1">
                                <i class="fas fa-info-circle mr-1"></i>
                                Información relevante sobre la trayectoria profesional del ponente
                            </p>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="social_links"
                                      ...
                                      class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all resize-none font-mono text-sm @error('social_links') border-red-500 @enderror">{{ old('social_links') }}</textarea>
                            @error('social_links')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                            <p class="text-xs text-gray-500 mt-1">
...
<script>
    // 🆕 VARIABLE GLOBAL PARA ALMACENAR BASE64
