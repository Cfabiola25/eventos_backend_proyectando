...
<div class="w-full px-4 py-6 mx-auto mt-16">
    ...
    <!-- Formulario -->
    <form action="{{ route('locations.update', $location->uuid) }}" method="POST" enctype="multipart/form-data" id="locationForm">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('reference_point', $location->reference_point) }}"
            ...
            <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div id="currentImage">
                            ...
                            <button type="button"
                                ...
                                <i class="fas fa-trash mr-2"></i>Cambiar Imagen
                            </button>
                        </div>
                        @endif
                        ...
                        <!-- Input de archivo -->
                        <div id="uploadArea" class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-primary-500 transition-colors cursor-pointer {{ $location->image ? 'hidden' : '' }}">
                            <input type="file"
                                id="image"
                                name="image"
                                accept="image/*"
                ...
                <div class="bg-red-50 rounded-lg border-l-4 border-primary-600 p-4">
                        ...
                        <div class="text-sm text-gray-700 flex-1">
                            ...
                            <div class="space-y-1">
                                <p class="text-xs flex items-center">
                                    ...
                                    <span class="font-medium mr-1">Creado:</span> {{ $location->created_at->format('d/m/Y H:i') }}
                                </p>
                                <p class="text-xs flex items-center">
                                    <i class="fas fa-calendar-check text-primary-600 mr-2 w-4"></i>
                                    <span class="font-medium mr-1">Actualizado:</span> {{ $location->updated_at->format('d/m/Y H:i') }}
                                </p>
                            </div>
                        </div>
                    </div>
