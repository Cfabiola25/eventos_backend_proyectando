                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="description" name="description" rows="4"
                                      ...
                                      class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="url" id="virtual_link" name="virtual_link" value="{{ old('virtual_link') }}"
                                ...
                                @foreach($schedules as $schedule)
                                    ...
                                    <label class="flex items-center cursor-pointer mb-3 p-3 hover:bg-white rounded-lg transition-colors border border-red-200 bg-red-50">
                                        <input type="checkbox" name="schedules[]" value="{{ $schedule->id }}"
                                               {{ in_array($schedule->id, old('schedules', [])) ? 'checked' : '' }}
                                               class="w-4 h-4 text-red-600 border-gray-300 rounded focus:ring-red-500">
                    ...
                    <div class="max-h-64 overflow-y-auto border border-gray-300 rounded-lg bg-gray-50">
                        <div id="speakersList" class="p-2">
                            @foreach($speakers as $speaker)
                                @php
                                    $isSelected = in_array($speaker->id, old('speakers', []));
                                @endphp
                    ...
                    <div class="bg-gradient-to-r from-orange-50 to-orange-100 border-2 border-orange-200 rounded-lg p-4">
                        <label for="is_active" class="flex items-center cursor-pointer">
                            <div class="relative">
                                ...
                                <div class="dot absolute left-1 top-1 bg-white w-6 h-6 rounded-full transition transform {{ old('is_active', 1) ? 'translate-x-6 bg-green-500' : '' }}"></div>
                            </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Funcionalidad para expositores mejorados
