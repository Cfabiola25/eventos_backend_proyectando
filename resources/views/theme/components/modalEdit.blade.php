<div id="editModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
    <div class="bg-white rounded-lg shadow-xl w-full max-w-2xl mx-4">
        <div class="bg-red-600 text-white p-4 rounded-t-lg flex justify-between items-center">
            <h3 class="text-lg font-semibold">Editar Tema</h3>
        ...
        <div class="p-6">
            <p class="text-gray-600 mb-4">Editando tema: <span id="editThemeTitle" class="font-semibold"></span></p>
            ...
            <form id="editForm" method="POST">
                ...
                <!-- Select de Agenda para editar -->
                <div class="mb-4">
                    <label for="edit_agenda_id" class="block text-sm font-medium text-gray-700 mb-1">Agenda Asociada</label>
                    <select name="agenda_id" id="edit_agenda_id"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-600 focus:border-red-600 hover:border-red-400 transition-colors">
                        <option value="">Seleccionar agenda (opcional)</option>
                ...
                <div class="mb-4">
                    <label for="edit_start_date" class="block text-sm font-medium text-gray-700 mb-1">Fecha Inicio *</label>
