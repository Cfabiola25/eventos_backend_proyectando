        ...
        <div class="p-6">
            <div class="flex items-center mb-4">
                <div class="flex-shrink-0">
                    <i class="fas fa-layer-group text-red-500 text-3xl"></i>
                </div>
                <div class="ml-4">
                    <p class="text-gray-700 font-medium">
                        ¿Está seguro que desea eliminar esta modalidad?
                    </p>
                    <p class="text-sm text-gray-600 mt-1">
                        Modalidad: <span id="delete-modality-name" class="font-semibold"></span>
                    </p>
                </div>
            </div>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-red-700">
                            ...
                            La modalidad será eliminada permanentemente del sistema.
                        </p>
                    </div>
                </div>
            </div>
