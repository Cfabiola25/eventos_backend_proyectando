        ...
        <div class="p-6">
            <div class="flex items-center mb-4">
                <div class="flex-shrink-0">
                    <i class="fas fa-list-alt text-red-500 text-3xl"></i>
                </div>
                <div class="ml-4">
                    ...
                    <p class="text-sm text-gray-600 mt-1">
                        Programa: <span id="delete-program-name" class="font-semibold"></span>
                    </p>
                </div>
            </div>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-red-700">
                            ...
                            El programa será eliminado permanentemente del sistema.
                        </p>
                    </div>
                </div>
            </div>
